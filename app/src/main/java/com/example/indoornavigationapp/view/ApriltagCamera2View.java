...
public class ApriltagCamera2View extends CameraBridgeViewBaseImpl {
    ...
    public ApriltagCamera2View(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    boolean calcPreviewSize(final int width, final int height) {
        ...
        try {
            ...
            org.opencv.core.Size frameSize = calculateCameraFrameSize(sizes_list, new ApriltagCamera2View.JavaCameraSizeAccessor(), width, height);
